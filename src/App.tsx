...
import BackgroundImage from './assets/Vetor de fundo de estúdio gradiente abstrato preto e branco _ Vetor Grátis.jpg';
  ...
  return (
    ...
    >
      <div className="flex flex-col min-h-screen bg-cover bg-center mt-8 mx-16">
        <div className="flex w-full h-48 bg-zinc-800 bg-opacity-60 items-center justify-start px-4 rounded-2xl">
        ...
        <div className="flex flex-col w-full bg-zinc-800 bg-opacity-60 text-zinc-200 px-8 py-10 rounded-2xl mt-8">
        ...
        <div className='flex flex-row space-x-14 mt-8 mb-8'>
          <div className='bg-zinc-800 bg-opacity-60 flex-grow h-auto rounded-2xl p-6'>
          ...
          <div className='bg-zinc-800 bg-opacity-60 w-1/3 h-80 rounded-2xl'>
          </div>
        </div>
      </div>
    </div>
